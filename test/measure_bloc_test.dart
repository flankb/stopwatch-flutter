...
void main() {
  group('MeasureBloc', () {
    ...
    blocTest<MeasureBloc, MeasureState>('measure bloc started test',
        build: () {
          return measureBloc;
        },
        act: (bloc) async {
    ...
    blocTest<MeasureBloc, MeasureState>('measure bloc exists laps test',
        build: () {
          return measureBloc;
        },
        act: (bloc) async {
        ...
        seed: () => MeasureStartedState(MeasureViewModel(
            id: 1,
        ...
        expect: () =>
            [isA<MeasureUpdatingState>(), isA<MeasureStartedState>()]);

    blocTest<MeasureBloc, MeasureState>('measure bloc paused test',
        build: () {
        ...
        seed: () {
          ...
          return MeasureStartedState(MeasureViewModel(
              id: 2,
    ...
    blocTest<MeasureBloc, MeasureState>('measure bloc finish test',
        build: () {
          repository = StopwatchFakeRepository(preBuild: true);
          return MeasureBloc(Ticker3(), repository);
        },
